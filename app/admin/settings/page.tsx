          ...
          <form onSubmit={handleSave} className="bg-white border border-slate-200 rounded-xl p-6 sm:p-8 shadow-xs flex flex-col gap-8">
            ...
            <div className="flex items-center justify-between pt-5 border-t border-slate-100">
              ...
              <button
                type="submit"
                disabled={isSaving}
                className="px-6 py-2.5 bg-slate-900 hover:bg-slate-800 disabled:opacity-75 text-white font-semibold rounded-lg text-xs transition-all shadow-sm flex items-center gap-2 cursor-pointer"
              >
                {isSaving ? (
                  <>
